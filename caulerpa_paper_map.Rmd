...
reachability_legend <- HTML('
  <div style="background:white; padding:8px; border-radius:5px; font-size:12px; line-height:1.4;">
    ...
    <div><span style="display:inline-block; width:12px; height:12px; border-radius:50%; background:red; margin-right:6px;"></span>< 0.25</div>
    <div><span style="display:inline-block; width:16px; height:16px; border-radius:50%; background:red; margin-right:6px;"></span>0.25 - 1</div>
    <div><span style="display:inline-block; width:20px; height:20px; border-radius:50%; background:red; margin-right:6px;"></span>1 - 2.5</div>
    <div><span style="display:inline-block; width:24px; height:24px; border-radius:50%; background:red; margin-right:6px;"></span>> 2.5</div>
    <div><span style="display:inline-block; width:14px; height:14px; border-radius:50%; background:#0070FF; margin-right:6px;"></span>Exotic <em>Caulerpa</em> sites</div>
...
# Survey Reachability
                        ...
                        addCircleMarkers(data = survey_reach_nodes_wgs84_NRC_NOANC.sf,
                                         ...
                                         group = "Survey Reachability",
                                         label = ~ paste0(Cmmn_nm, ", ", Region),
                                         popup = ~ paste0(Cmmn_nm, ", ID:", nID, ", ", Region)
                                         ) %>%
                        ...
                        addCircleMarkers(data = survey_leaflet_84_5kn_REM.sf2,
                                         ...
                                         fillOpacity = 5,
                                         group = "Survey Downstream",
                                         popup = ~ paste0(Cmmn_nm, ", ",  Type, ", ID:", nID, ", ", Region, ", Percentage of Incoming Vessels Nationwide: ", TON)) %>%    # Add non Northland nodes
                        addCircleMarkers(data = survey_leaflet_84_5kn_NRC_NOANC.sf,
                                         ...
                                         fillOpacity = 5,
                                         group = "Survey Downstream",
                                         popup = ~ paste0(Cmmn_nm,", ",  Type, ", ID:", nID, ", ", Region, ", Incoming Vessels = ", incmng_, ", Percentage of Incoming Vessels Nationwide: ", per_inc, "%")) %>%             # Add non-anchorage Northland nodes
                        addCircleMarkers(data = survey_leaflet_84_5kn_REM_INF.sf,
                                         ...
                                         fillOpacity = 5,
                                         group = "Survey Downstream",
                                         popup = ~ paste0(Cmmn_nm,", ",  Type, ", ID:", nID, ", ", Region)) %>% # Added infected nodes
                        addCircleMarkers(data = survey_leaflet_84_5kn_NRC_OMA.sf,
                                         ...
                                         fillOpacity = ~per_inc,
                                         group = "Survey Downstream",
                                         popup = ~ paste0(Cmmn_nm,", ",  Type, ", ID:", nID, ", ", Region, ", Incoming Vessels = ", incmng_, ", Percentage of Incoming Vessels Nationwide: ", per_inc, "%")) %>% # adds Infected BOI node
                        addCircleMarkers(data = survey_leaflet_84_5kn_NRC_ANC.sf,
                                         ...
                                         fillOpacity = ~per_inc,
                                         group = "Survey Downstream",
                                         popup = ~ paste0(Cmmn_nm,", ",  Type, ", ID:", nID, ", ", Region, ", Incoming Vessels = ", incmng_, ", Percentage of Incoming Vessels Nationwide: ", per_inc, "%")) %>% # adds northland anchoring nodes
                        # AIS Downstream
                        ...
                        addCircleMarkers(data = ais_leaflet_84_5kn_REM.sf2,
                                         ...
                                         fillOpacity = 5,
                                         group = "AIS Downstream",
                                         popup = ~ paste0(Cmmn_nm, ", ",  Tr1_typ, ", ID:", nID, ", ", Region, ", Percentage of Incoming Vessels Nationwide: ", Perc_tot)) %>%    # Add non Northland nodes
                        addCircleMarkers(data = ais_leaflet_84_5kn_NRC_NOANC.sf,
                                         ...
                                         fillOpacity = 5,
                                         group = "AIS Downstream",
                                         popup = ~ paste0(Cmmn_nm,", ",  Tr1_typ, ", ID:", nID, ", ", Region, ", Incoming Vessels = ", in_strn, ", Percentage of Incoming Vessels Nationwide: ", Perc_tot, "%")) %>%             # Add non-anchorage Northland nodes
                        addCircleMarkers(data = ais_leaflet_84_5kn_REM_INF.sf,
                                         ...
                                         fillOpacity = 5,
                                         group = "AIS Downstream",
                                         popup = ~ paste0(Cmmn_nm,", ",  Tr1_typ, ", ID:", nID, ", ", Region)) %>% # Added infected nodes
                        addCircleMarkers(data = ais_leaflet_84_5kn_NRC_ANC.sf,
                                         ...
                                         group = "AIS Downstream",
                                         popup = ~ paste0(Cmmn_nm,", ",  Tr1_typ, ", ID:", nID, ", ", Region, ", Incoming Vessels = ", in_strn, ", Percentage of Incoming Vessels Nationwide: ", Perc_tot, "%"))  # adds northland anchoring nodes              
...
if(write_outputs){
  ...
  saveWidget(caulerpa_leaflet.plot, 
             file = file.path(figure_directory, "caulerpa_leaflet_v1.html"), 
             selfcontained = TRUE)
  
  message("Caulerpa leaflet map saved to ", file.path(figure_directory, "caulerpa_leaflet_v1.html"))
}
