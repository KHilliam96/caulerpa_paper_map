...
caulerpa_leaflet.plot <- leaflet() %>%
                        ...
                        addCircleMarkers(data = ais_reach_nodes_wgs84.sf,
                                         color = "steelblue",
                                         radius = 3,
                                         opacity = 1,
                                         group = "AIS Reachability",
                        ...
                        addCircleMarkers(data = ais_down_nodes_wgs84.sf,
                                         radius = 3,
                                         color = "red",
                                         weight = 1,                        
                                         fillOpacity = 0.7,
                               ...
                               addControl(html = "<div id='map-title' style='font-weight: bold;'>NZ Domestic Vessel Caulerpa Reach</div>", 
                                ...
                                addLayersControl(baseGroups = c("OSM Mapnik",
                                                        "Esri Gray",
                                                        "CartoDB"),
                                         options = layersControlOptions(collapsed = TRUE)) %>% # Layer control
                                hideGroup(c("Survey Downstream",
                                            "AIS Reachability",
                                            "AIS Downstream")) %>% # Hide all but first 
