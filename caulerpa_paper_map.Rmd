...
# Edges
  ...
  # edge_leaflet_recreational.sf$TWSA_bin <- cut(edge_leaflet_recreational.sf$TWSA, breaks = TWSA_breaks_edges,
  #                                              labels = c("<22.3", "22.3 - 73.2", "73.3 - 331.36", "331.37 - 5347.49", ">5347.49"))
  # edge_leaflet_both.sf$TWSA_bin <- cut(edge_leaflet_both.sf$TWSA, breaks = TWSA_breaks_edges,
  #                                      labels = c("<22.3", "22.3 - 73.2", "73.3 - 331.36", "331.37 - 5347.49", ">5347.49"))
  # 
  # # View the modified dataframe
  # head(edge_leaflet_commercial.sf)
...
caulerpa_leaflet.plot <- leaflet() %>%
                        ...
                        addCircleMarkers(data = survey_leaflet_84_5kn_REM.sf2,
                                         ...
                                         fillOpacity = 5,
                                         group = "Survey Downstream",
                                         popup = ~ paste0(name, ", ",  Type, ", ID:", nID, ", ", Region, ", Percentage of Incoming Vessels in the TON: ", TON)) %>%    # Add non Northland nodes
                        addCircleMarkers(data = survey_leaflet_84_5kn_NRC_NOANC.sf,
                                         ...
                                         fillOpacity = 5,
                                         group = "Survey Downstream",
                                         popup = ~ paste0(name,", ",  Type, ", ID:", nID, ", ", Region, ", Incoming Vessels = ", incmng_, ", Percentage of Incoming Vessels in the Region: ", per_inc, "%")) %>%             # Add non-anchorage Northland nodes
                        ...
                        addCircleMarkers(data = survey_leaflet_84_5kn_NRC_OMA.sf,
                                         ...
                                         fillOpacity = ~per_inc,
                                         group = "Survey Downstream",
                                         popup = ~ paste0(name,", ",  Type, ", ID:", nID, ", ", Region, ", Incoming Vessels = ", incmng_, ", Percentage of Incoming Vessels in the Region: ", per_inc, "%")) %>% # adds Infected BOI node
                        addCircleMarkers(data = survey_leaflet_84_5kn_NRC_ANC.sf,
                                         ...
                                         fillOpacity = ~per_inc,
                                         group = "Survey Downstream",
                                         popup = ~ paste0(name,", ",  Type, ", ID:", nID, ", ", Region, ", Incoming Vessels = ", incmng_, ", Percentage of Incoming Vessels in the Region: ", per_inc, "%")) %>% # adds northland anchoring nodes
